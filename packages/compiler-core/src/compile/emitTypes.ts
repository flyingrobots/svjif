...
export class TypeEmitter {
  ...
  emit(): string {
    ...
    tokens.push('// Auto-generated by @svjif/compiler-core — do not edit\n');
    tokens.push('\n');

    // NodeId union — sorted lexicographically for deterministic output
    const nodeIds = [...this.ast.nodes.map((n) => n.id)].sort();
